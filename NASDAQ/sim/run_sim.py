"""Run all NASDAQ agent strategies through the engine and dump results.
...
def main() -> int:
    ...
    for a in agents:
        ...
        print(f"{a.handle:>12}: final {sm['final_equity']:>12,.0f} USD "
    ...
    print(f"{'IXIC':>12}: final {tasi_metrics['final_equity']:>12,.0f} USD "
